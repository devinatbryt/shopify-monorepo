...
> & {
  ...
  discountCodes: Array<
    Pick<StorefrontTypes.CartDiscountCode, "applicable" | "code">
  >;
  lines: {
    pageInfo: Pick<
      ...
      | (Pick<StorefrontTypes.CartLine, "id" | "quantity"> & {
          ...
          cost: {
            amountPerQuantity: Pick<
              ...
              "amount" | "currencyCode"
            >;
            compareAtAmountPerQuantity?: StorefrontTypes.Maybe<
          ...
          sellingPlanAllocation?: StorefrontTypes.Maybe<{
            sellingPlan: Pick<StorefrontTypes.SellingPlan, "id" | "name">;
          }>;
          ...
          > & {
              ...
              > & {
                featuredImage?: StorefrontTypes.Maybe<
                  ...
                  > & {
                    thumbnail: StorefrontTypes.Image["url"];
                    small: StorefrontTypes.Image["url"];
                    large: StorefrontTypes.Image["url"];
                    original: StorefrontTypes.Image["url"];
                  }
                >;
                options: Array<
                  Pick<StorefrontTypes.ProductOption, "name" | "values">
                >;
                sellingPlanGroups: {
                  nodes: Array<{
                    sellingPlans: {
                      nodes: Array<
                        Pick<StorefrontTypes.SellingPlan, "id" | "name">
                      >;
                    };
                  }>;
                };
...
export type UpdateCartNoteMutation = {
  cartNoteUpdate?: StorefrontTypes.Maybe<{
    cart?: StorefrontTypes.Maybe<
      Pick<
        StorefrontTypes.Cart,
        "id" | "checkoutUrl" | "note" | "totalQuantity"
...
export type UpdateCartDiscountsMutationVariables = StorefrontTypes.Exact<{
  id: StorefrontTypes.Scalars["ID"]["input"];
  discountCodes?: StorefrontTypes.InputMaybe<
    | Array<StorefrontTypes.Scalars["String"]["input"]>
    | StorefrontTypes.Scalars["String"]["input"]
  >;
}>;

export type UpdateCartDiscountsMutation = {
  cartDiscountCodesUpdate?: StorefrontTypes.Maybe<{
    cart?: StorefrontTypes.Maybe<
...
export type CartAttributesUpdateMutationVariables = StorefrontTypes.Exact<{
  id: StorefrontTypes.Scalars["ID"]["input"];
  attributes:
    | Array<StorefrontTypes.AttributeInput>
    | StorefrontTypes.AttributeInput;
}>;

export type CartAttributesUpdateMutation = {
  cartAttributesUpdate?: StorefrontTypes.Maybe<{
    cart?: StorefrontTypes.Maybe<
      Pick<
        StorefrontTypes.Cart,
        "id" | "checkoutUrl" | "note" | "totalQuantity"
...
interface GeneratedQueryTypes {
  "#graphql\n    query getCartId($id: ID!) {\n        cart(id: $id) {\n          id\n        }\n    }\n": {
    return: GetCartIdQuery;
    variables: GetCartIdQueryVariables;
  };
...
interface GeneratedMutationTypes {
  ...
  "#graphql\n    mutation updateCartLines($id: ID!, $lines: [CartLineUpdateInput!]!) {\n      cartLinesUpdate(cartId: $id, lines: $lines) {\n        cart {\n          ...CartFragment\n        }\n        userErrors {\n          field\n          message\n        }\n      }\n    }\n    #graphql\n    fragment CartFragment on Cart {\n        id\n        attributes {\n          key\n          value\n        }\n        cost {\n          subtotalAmount {\n            amount\n            currencyCode\n          }\n          totalAmount {\n            amount\n            currencyCode\n          }\n        }\n        checkoutUrl\n        discountAllocations {\n          discountedAmount {\n            amount\n            currencyCode\n          }\n        }\n        discountCodes {\n          applicable\n          code\n        }\n        note\n        totalQuantity\n        lines(first: 250) {\n          pageInfo {\n            hasNextPage\n            hasPreviousPage\n            startCursor\n            endCursor\n          }\n          nodes {\n            attributes {\n              key\n              value\n            }\n            cost {\n              amountPerQuantity {\n                amount\n                currencyCode\n              }\n              compareAtAmountPerQuantity {\n                amount\n                currencyCode\n              }\n              subtotalAmount {\n                amount\n                currencyCode\n              }\n              totalAmount {\n                amount\n                currencyCode\n              }\n            }\n            discountAllocations {\n              discountedAmount {\n                amount\n                currencyCode\n              }\n            }\n            id\n            quantity\n            sellingPlanAllocation {\n              sellingPlan {\n                id\n                name\n              }\n            }\n            variant: merchandise {\n               __typename\n              ... on ProductVariant {\n                id\n                title\n                quantityAvailable\n                availableForSale\n                currentlyNotInStock\n                requiresShipping\n                selectedOptions {\n                  name\n                  value\n                }\n                sku\n                product {\n                  id\n                  title\n                  handle\n                  onlineStoreUrl\n                  featuredImage {\n                    altText\n                    height\n                    id\n                    thumbnail: url(transform: { maxWidth: 150, maxHeight: 150 })\n                    small: url(transform: { maxWidth: 250, maxHeight: 250 })\n                    large: url(transform: { maxWidth: 500, maxHeight: 500 })\n                    original: url\n                    width\n                  }\n                  options {\n                    name\n                    values\n                  }\n                  sellingPlanGroups(first: 1) {\n                    nodes {\n                      sellingPlans(first: 12) {\n                        nodes {\n                          id\n                          name\n                        }\n                      }\n                    }\n                  }\n                  variants(first: 50) {\n                    nodes {\n                      id\n                      title\n                      availableForSale\n                    }\n                  }\n                }\n                image {\n                  altText\n                  height\n                  id\n                  thumbnail: url(transform: { maxWidth: 150, maxHeight: 150 })\n                  small: url(transform: { maxWidth: 250, maxHeight: 250 })\n                  large: url(transform: { maxWidth: 500, maxHeight: 500 })\n                  original: url\n                  width\n                }\n              }\n            }\n          }\n        }\n      }\n\n": {
    return: UpdateCartLinesMutation;
    variables: UpdateCartLinesMutationVariables;
  };
  "#graphql\n    mutation updateCartNote($id: ID!, $note: String!) {\n      cartNoteUpdate(cartId: $id, note: $note) {\n        cart {\n          ...CartFragment\n        }\n        userErrors {\n          field\n          message\n        }\n      }\n    }\n    #graphql\n    fragment CartFragment on Cart {\n        id\n        attributes {\n          key\n          value\n        }\n        cost {\n          subtotalAmount {\n            amount\n            currencyCode\n          }\n          totalAmount {\n            amount\n            currencyCode\n          }\n        }\n        checkoutUrl\n        discountAllocations {\n          discountedAmount {\n            amount\n            currencyCode\n          }\n        }\n        discountCodes {\n          applicable\n          code\n        }\n        note\n        totalQuantity\n        lines(first: 250) {\n          pageInfo {\n            hasNextPage\n            hasPreviousPage\n            startCursor\n            endCursor\n          }\n          nodes {\n            attributes {\n              key\n              value\n            }\n            cost {\n              amountPerQuantity {\n                amount\n                currencyCode\n              }\n              compareAtAmountPerQuantity {\n                amount\n                currencyCode\n              }\n              subtotalAmount {\n                amount\n                currencyCode\n              }\n              totalAmount {\n                amount\n                currencyCode\n              }\n            }\n            discountAllocations {\n              discountedAmount {\n                amount\n                currencyCode\n              }\n            }\n            id\n            quantity\n            sellingPlanAllocation {\n              sellingPlan {\n                id\n                name\n              }\n            }\n            variant: merchandise {\n               __typename\n              ... on ProductVariant {\n                id\n                title\n                quantityAvailable\n                availableForSale\n                currentlyNotInStock\n                requiresShipping\n                selectedOptions {\n                  name\n                  value\n                }\n                sku\n                product {\n                  id\n                  title\n                  handle\n                  onlineStoreUrl\n                  featuredImage {\n                    altText\n                    height\n                    id\n                    thumbnail: url(transform: { maxWidth: 150, maxHeight: 150 })\n                    small: url(transform: { maxWidth: 250, maxHeight: 250 })\n                    large: url(transform: { maxWidth: 500, maxHeight: 500 })\n                    original: url\n                    width\n                  }\n                  options {\n                    name\n                    values\n                  }\n                  sellingPlanGroups(first: 1) {\n                    nodes {\n                      sellingPlans(first: 12) {\n                        nodes {\n                          id\n                          name\n                        }\n                      }\n                    }\n                  }\n                  variants(first: 50) {\n                    nodes {\n                      id\n                      title\n                      availableForSale\n                    }\n                  }\n                }\n                image {\n                  altText\n                  height\n                  id\n                  thumbnail: url(transform: { maxWidth: 150, maxHeight: 150 })\n                  small: url(transform: { maxWidth: 250, maxHeight: 250 })\n                  large: url(transform: { maxWidth: 500, maxHeight: 500 })\n                  original: url\n                  width\n                }\n              }\n            }\n          }\n        }\n      }\n\n": {
    return: UpdateCartNoteMutation;
    variables: UpdateCartNoteMutationVariables;
  };
  "#graphql\n    mutation updateCartDiscounts($id: ID!, $discountCodes: [String!]) {\n      cartDiscountCodesUpdate(cartId: $id, discountCodes: $discountCodes) {\n        cart {\n          id\n          discountCodes {\n            code\n            applicable\n          }\n        }\n        userErrors {\n          field\n          message\n        }\n      }\n    }\n": {
    return: UpdateCartDiscountsMutation;
    variables: UpdateCartDiscountsMutationVariables;
  };
